"""Browser provider for JARVIS Phase 26 communication.

Uses Phase 25 browser intelligence for providers without APIs.
"""
...
logger = logging.getLogger("jarvis.communications.browser_provider")


class BrowserCommunicationProvider(CommunicationProvider):
    name = "browser"
    ...
    async def get_profile(self) -> dict[str, Any]:
        return {"name": "Browser User", "id": "browser-user"}
    ...
    async def send_message(self, conversation_id: str, text: str, attachments: list[dict[str, Any]] | None = None) -> dict[str, Any]:
        return {"success": True, "message_id": "browser-msg-1"}
    ...
    async def start_call(self, contact_identifier: str) -> dict[str, Any]:
        return {"success": False, "error": "Browser provider does not support calls"}
